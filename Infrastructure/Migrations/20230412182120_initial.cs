        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectAnswser = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IncorrectAnswerId = table.Column<int>(type: "int", nullable: false),
                    QuizItemsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizItemAnswerEntityQuizItemEntity", x => new { x.IncorrectAnswerId, x.QuizItemsId });
                    table.ForeignKey(
                        name: "FK_QuizItemAnswerEntityQuizItemEntity_IncorrectAnswers_IncorrectAnswerId",
                        column: x => x.IncorrectAnswerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswers", x => new { x.UserId, x.QuizItemId, x.QuizId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizEntityQuizItemEntity", x => new { x.ItemsId, x.QuizesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizEntityQuizItemEntity_Quizzes_QuizesId",
                        column: x => x.QuizesId,
            ...
            migrationBuilder.InsertData(
                table: "QuizItems",
                columns: new[] { "Id", "CorrectAnswser", "Question" },
                values: new object[,]
                {
                    { 1, "5", "2 + 3" },
                    { 2, "6", "2 * 3" },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "IncorrectAnswerId", "QuizItemsId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 1, 3 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizEntityQuizItemEntity_QuizesId",
                table: "QuizEntityQuizItemEntity",
                column: "QuizesId");
